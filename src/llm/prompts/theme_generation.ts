...
2. Themes should be short, human-readable labels (2-4 words), not full sentences.
3. Avoid overly fragmented themes; merge very similar concepts into a single theme.
4. Try to keep the total number of themes small and meaningful.
5. Every unit MUST be mapped to one existing theme_name.
6. Do NOT invent new fields or change the field names.
7. Respond with JSON ONLY, no comments or extra text.
`.trim();
